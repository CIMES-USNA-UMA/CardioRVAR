...
```
As there is a breakpoint, the data is not stationary. We will separate the data into two stationary subsets, Pre and Post:
...
GetExpectedValues(good_model, coherence = coh, str = FALSE)$LF$Transfer_Functions[2,1,]
```
...
GetExpectedValues(good_model, coherence = coh, str = FALSE)$LF$Transfer_Functions[1,2,]
```
